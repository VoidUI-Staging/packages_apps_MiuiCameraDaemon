...
#undef LOG_TAG
#define LOG_TAG "MIA_CLEARSHOT_A"

namespace mialgo {

////////////////////////////////////////////////////////////////////////////////////////////////////
/// MiaNodeClearShot::Initialize
////////////////////////////////////////////////////////////////////////////////////////////////////
CDKResult MiaNodeClearShot::Initialize(void)
{
    ALOGD("MiaNodeClearShot::Initialize start %s : %d", __func__, __LINE__);
    CDKResult result = MIAS_OK;

    m_pNodeInstance = new QVisidonClearshot();
    m_pNodeInstance->init();

    setType(NDTP_CLEARSHOT);
    m_processedFrame = 0;

    ALOGD("MiaNodeClearShot::Initialize end %s : %d", __func__, __LINE__);
    return result;
}

CDKResult MiaNodeClearShot::DeInit(void)
{
    CDKResult result = MIAS_OK;
...
CDKResult MiaNodeClearShot::PrePareMetaData(void *meta)
{
...
CDKResult MiaNodeClearShot::FreeMetaData(void)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// MiaNodeClearShot::ProcessRequest
////////////////////////////////////////////////////////////////////////////////////////////////////
CDKResult MiaNodeClearShot::ProcessRequest(NodeProcessRequestInfo* pProcessRequestInfo)
{
    ...
    for (uint32_t i = 0; i < pProcessRequestInfo->inputNum; i++)
    {
        ...
        if (iIsDumpData && pProcessRequestInfo->inputNum >1)
        {
            ...
            snprintf(inbuf, sizeof(inbuf), "clearshot_input_%dx%d_%d",
                    inputFrame[i].Pitch[0], hInput->format.height, i);
    ...
    iso = (int)(ispGain * 100) * sensitivity / 100;
    ALOGE("MIALGO_clearshot: iso: %d",iso);

    nsecs_t e2 = systemTime();
    if (m_pNodeInstance)
        m_pNodeInstance->process(inputFrame, &outputFrame, pProcessRequestInfo->inputNum, iso, &baseframe);
    ...
    if(iIsDumpData && pProcessRequestInfo->inputNum >1)
    {
        ...
        snprintf(outbuf, sizeof(outbuf), "clearshot_output_%dx%d",
                outputFrame.Pitch[0], hOutput->format.height);
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// MiaNodeClearShot::MiaNodeClearShot
////////////////////////////////////////////////////////////////////////////////////////////////////
MiaNodeClearShot::MiaNodeClearShot(): m_processedFrame(0), m_pNodeInstance(NULL), m_pRequestSetting(NULL)
{
    ALOGD("now construct -->> MiaNodeClearShot\n");
}
...
MiaNodeClearShot::~MiaNodeClearShot()
{
    ALOGD("now distruct -->> MiaNodeClearShot\n");
}

////////////////////////////////////////////////////////////////////////////////////////////////////
/// MiaNodeClearShot::UpdateMetaData
////////////////////////////////////////////////////////////////////////////////////////////////////
void MiaNodeClearShot::UpdateMetaData(uint64_t requestId)
{
    ALOGD("UpdateMetaData %llu", requestId);
}
