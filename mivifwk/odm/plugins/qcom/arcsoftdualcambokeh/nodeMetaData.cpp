...
S32 NodeMetaData::GetArcsoftCropsize(camera_metadata_t *mdata, MRECT *cropsize)
{
    DEV_IF_LOGE_RETURN_RET(cropsize == NULL, RET_ERR_ARG, "arg err");
    S32 ret = RET_ERR;
    void *pData = NULL;
    ret = GetMetaData(mdata, "xiaomi.bokeh.hdrCropsize", 0, &pData, NULL);
    DEV_IF_LOGE_RETURN_RET(ret != RET_OK, ret, "GetMetadata err");
    DEV_IF_LOGE_RETURN_RET(pData == NULL, RET_ERR, "get metadata err");
    (*cropsize) = *reinterpret_cast<MRECT *>(pData);
    return RET_OK;
}
