...
#if defined(WINDOWS_OS)
#define __pid() GetCurrentProcessId()
#define __tid() GetCurrentThreadId()
#elif defined(LINUX_OS)
#define __pid() getpid()
#define __tid() gettid()
#elif defined(ANDROID_OS)
...
#define MARK(__tag)         __FILE__,__LINE__,__pid(),__tid(),__tag
#define MARK_TAG            const char *__fileName, U32 __fileLine, U64 __pid, U64 __tid,const char *
