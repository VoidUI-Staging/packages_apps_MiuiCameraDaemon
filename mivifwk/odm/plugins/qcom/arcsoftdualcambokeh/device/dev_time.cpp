...
S64 DevTime_GetTimeStr(char* string) {
    ...
    sprintf((char *) string, "%02d-%02d-%02d-%02d-%02d-%02d-%06.0f", dateTime.year, dateTime.month, dateTime.day, dateTime.hour, dateTime.minute, dateTime.second, (double)dateTime.nsecond);
    return RET_OK;
}
