...
public:
	 ...
	 */
	virtual MRESULT	Init(const MInt32 nInterfaceVersion, ABS_MODE nMode)=0;
	 ...
	 * [IN] nRegion: Region type of ABS_REGION.
	 */
	virtual MRESULT Process(LPASVLOFFSCREEN pImgIn, LPASVLOFFSCREEN pImgOut, ABS_TFaces *pFacesIn, ABS_TFaces *pFacesOut, MInt32 nFaceOrientation, ABS_REGION nRegion)=0;
};
