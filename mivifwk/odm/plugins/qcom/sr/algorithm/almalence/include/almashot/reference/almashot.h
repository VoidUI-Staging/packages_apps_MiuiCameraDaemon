...
void AlmaShot_SubsampleForPreview(Uint8 *restrict in, Uint8 *restrict out, int sx, int sy, int sxp,
                                  int syp);

void AlmaShot_ComposeRGBi(Uint8 *in, Uint8 *out, int sx, int sy, int x0, int y0, int w, int h,
                          int pitch);

void AlmaShot_ComposeRotatedRGBi(Uint8 *in, Uint8 *out, int sx, int sy, int x0, int y0, int w,
                                 int h, int pitch);

void AlmaShot_Preview2RGBi(Uint8 *in, Uint8 *out, int sx, int sy, int x0, int y0, int w, int h,
                           int pitch);

void AlmaShot_ComposeRGBAi(Uint8 *in, Uint8 *out, int sx, int sy, int x0, int y0, int w, int h,
                           int pitch);

void AlmaShot_ComposeBGRAi(Uint8 *in, Uint8 *out, int sx, int sy, int x0, int y0, int w, int h,
                           int pitch);

void AlmaShot_ComposeRotatedRGBAi(Uint8 *in, Uint8 *out, int sx, int sy, int x0, int y0, int w,
                                  int h, int pitch);

void AlmaShot_ComposeRotatedBGRAi(Uint8 *in, Uint8 *out, int sx, int sy, int x0, int y0, int w,
                                  int h, int pitch);

void AlmaShot_Preview2RGBAi(Uint8 *in, Uint8 *out, int sx, int sy, int x0, int y0, int w, int h,
                            int pitch);

void AlmaShot_Preview2BGRAi(Uint8 *in, Uint8 *out, int sx, int sy, int x0, int y0, int w, int h,
                            int pitch);

void AlmaShot_SwapUV(Uint8 *restrict in, int sx, int sy);

void AlmaShot_ConvertNV12toNV16(Uint8 *restrict in, Uint8 *restrict out, int sx, int sy);

void AlmaShot_ConvertNV21toUYVY(Uint8 *restrict in, Uint8 *restrict out, int sx, int sy);
