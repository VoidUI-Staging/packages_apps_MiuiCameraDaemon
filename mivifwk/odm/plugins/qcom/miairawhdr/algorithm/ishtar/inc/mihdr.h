...
enum MIAI_HDR_ALGO_TYPE { RAW_HDR, YUV_HDR, MAX_TYPE_NUM };
...
union HDRMetaData {
    ...
    struct _config
    {
        ...
        char ev0_preprocess;
        uint32_t hdrSnapShotStyle; // 0:normal 1:classic
...
void processRawData(MiImageBuffer *buffer, int ev, int frameNum, GainInfo *info,
                    HDRMetaData *hdrMetaData);
