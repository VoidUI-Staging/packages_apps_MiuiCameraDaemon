...
typedef struct _tag_MIAI_HDR_RAWEXIF
{
    MInt32 rotate;
    MInt32 camera_id;
    MInt32 width;
    ...
    MFloat blue_gain;
    MFloat luxindex;
    MFloat analog_gain[HDR_RAW_MAX_LEN];
    MFloat digital_gain[HDR_RAW_MAX_LEN];
    MFloat shutter[HDR_RAW_MAX_LEN];
    MFloat ev[HDR_RAW_MAX_LEN];
    MInt32 is_fushion_phase2;
    MFloat merge_gain[HDR_RAW_MAX_LEN];
    MInt32 is_potrait_scene;
    MInt32 scene_type[5];
    MFloat bright_mean[4];
    MInt32 ref_id;
    MInt32 ev0_id;
    MInt32 alface;
    MInt32 discard_frame;
} MIAI_HDR_RAWEXIF;
