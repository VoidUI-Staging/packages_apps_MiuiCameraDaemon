...
typedef struct AlgoDepthInitParams
{
    ...
    AlgoMultiCams::MiRect mianCropRegion;                    // [in]  Main crop region coordinate, (x,y):left-top point, w:the width of rect, h:the height of rect.
    AlgoMultiCams::MiRect auxCropRegion;                     // [in]  Aux crop region coordinate, (x,y):left-top point, w:the width of rect, h:the height of rect.
} AlgoDepthInitParams;
