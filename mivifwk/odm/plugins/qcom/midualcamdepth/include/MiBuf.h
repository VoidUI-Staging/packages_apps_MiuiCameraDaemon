...
void MiAssignBuffer(struct MiImageBuffer *buffer, int width, int height, int stride, unsigned char* data);
...
void yuv420sp2rgba(unsigned char *py, unsigned char *puv, unsigned char *rgba, int stride_y, int stride_uv, int width, int height);
void rgba2yuv420sp(unsigned char *py, unsigned char *puv, unsigned char *rgba, int stride_y, int stride_uv, int width, int height);
