...
typedef struct AlgoBokehLaunchParams
{
    ...
    bool isQuickSnap;                                            //[in] true for quick snap mode and false is non-quick snap mode
    bool isUserTouch;                                            //[in] true when user touch focusing and false when auto focusing
