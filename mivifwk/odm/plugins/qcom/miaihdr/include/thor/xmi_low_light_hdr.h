...
LOWLIGHTHDR_API MRESULT XMI_LLHDR_GetDefaultParam(LPXMI_LLHDR_PARAM pParam,MInt32 isoValue,MInt32 cameratype);
...
LOWLIGHTHDR_API MVoid XMI_LLHDR_SetEVValue(
    MHandle            hEnhancer,            // [in]  The algorithm engine
    MFloat            EvValue                // [in] The parameter of EV Value
);

LOWLIGHTHDR_API MVoid  XMI_LLHDR_SetCallback(
    MHandle                hHandle,            // [in]  The algorithm engine
