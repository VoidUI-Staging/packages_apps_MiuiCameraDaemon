...
public:
    ...
    S32 GetExtremeDarkSeResult(camera_metadata_t *mdata, S32 *extremeDarkSeResult);
    ...
    S32 GetArcsoftFaceInfo(camera_metadata_t *pMdata, DEV_IMAGE_BUF *inputMain,
