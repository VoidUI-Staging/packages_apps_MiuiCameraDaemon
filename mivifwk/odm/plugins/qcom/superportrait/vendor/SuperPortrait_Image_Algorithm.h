...
*-------------------------------------------------------------------------------------------------*/
/*
* SuperPortrait_Image_Algorithm.h
*
* Reference:
*
* Description:
...
#ifndef ____SUPERPORTRAIT_IMAGE_ALGORITHM_H_20150805____
#define ____SUPERPORTRAIT_IMAGE_ALGORITHM_H_20150805____
...
class SuperPortrait_Image_Algorithm : public AISF_NS::AISFReferenceInter
{
public:
	/*
	 *The unique ID of the SuperPortrait_Image_Algorithm SDK, used in Create_SuperPortrait_Image_Algorithm().
	 */
	static const MInt32 CLASSID = 0;
	/*
	 * Initialize the SuperPortrait_Image_Algorithm SDK.
	 */
	virtual MRESULT	Init()=0;
	/*
	 * Uninitialize the SuperPortrait_Image_Algorithm SDK. MUST correspond with Init().
	 */
	virtual MRESULT	UnInit()=0;

	/*
	 * Get the SuperPortrait_Image_Algorithm SDK's version.
	 */
	...
	/*
	 *
	 * Set/Get feature level to/from the SuperPortrait_Image_Algorithm SDK
	...
	/*
	 * Set/Get feature level array to/from the SuperPortrait_Image_Algorithm SDK
	 * nFeatureKey: feature key defined in abstypes.h
	...
	/*
	 * Set/Get feature color to/from the SuperPortrait_Image_Algorithm SDK
	 * nFeatureKey: feature key defined in abstypes.h
...
/*
 * The function exported by the dynamic so, which is used to create the SuperPortrait_Image_Algorithm SDK object.
 * Parameters:
 *   [IN] ClassID : The unique class ID, defined as SuperPortrait_Image_Algorithm::CLASSID.
 *   [OUT] ppalgorithm: The SuperPortrait_Image_Algorithm SDK object will be created in this function with reference count as 1.
...
ARC_BS_API MInt32 Create_SuperPortrait_Image_Algorithm(const MInt32 ClassID,
													   SuperPortrait_Image_Algorithm** ppalgorithm);
...
#endif	//____SUPERPORTRAIT_IMAGE_ALGORITHM_H_20150805____
