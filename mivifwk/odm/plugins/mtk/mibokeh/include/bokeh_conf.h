...
struct SegmentConf
{
    ...
    SegmentConf(Orientation photo_orient, bool photo_flip, int async_seg_peroid_ms,
                ...
                float divider, float depth_divider_r, float depth_divider_g, float depth_divider_b,
                int gf_radius, float gf_eps, BokehModelShape model, bool with_det, bool with_refine,
                float portrait_th, int portrait_area)
        : photo_orient_(photo_orient),
          ...
          mean_b_(mean_b),
          divider_(divider),
          divider_r_(depth_divider_r),
          divider_g_(depth_divider_g),
          divider_b_(depth_divider_b),
