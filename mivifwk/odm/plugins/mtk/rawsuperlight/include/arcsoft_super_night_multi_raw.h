...
// camera mode
#define CAMERA_MODE_XIAOMI_L11_D2000_HM2_Y \
    0x77D // 1917  	  L11_D2000(HM2) OIS_Y
          // Pure_RAW_12_16//W
#define CAMERA_MODE_XIAOMI_L11_D2000_SKG4H7_N \
    0x77E // 1918  	  L11_D2000(SKG4H7) OIS_N Pure_RAW_12_16//UW
#define CAMERA_MODE_XIAOMI_L11_D2000_GC02M1_N \
    0x77F // 1919  	  L11_D2000(GC02M1) OIS_N Pure_RAW_12_16//Tele

#define CAMERA_MODE_XIAOMI_L11A_D1500_IMX582_Y \
    0x781 // 1921 	  L11A_D1500(IMX582) OIS_Y Pure_RAW_12_16//W
#define CAMERA_MODE_XIAOMI_L11A_D1500_SKG4H7_N \
    0x782 // 1922 	  L11A_D1500(SKG4H7) OIS_N Pure_RAW_12_16//UW
#define CAMERA_MODE_XIAOMI_L11A_D1500_GC02M1_N \
    0x783 // 1923 	  L11A_D1500(GC02M1) OIS_N Pure_RAW_12_16//Tele

#define CAMERA_MODE_XIAOMI_L12A_INT_D1500_S5KHM6 \
    0x7B9                                              // 1977  	  L12A_INT_D1500(S5KHM6 OIS_Y)
                                                       // //W
#define CAMERA_MODE_XIAOMI_L12A_INT_D1500_S5K4H7 0x7BA // 1978  	  L12A_INT_D1500(S5K4H7)//UW
#define CAMERA_MODE_XIAOMI_L12A_INT_D1500_GC02M1 0x7BB // 1979 L12A_INT_D1500(GC02M1)//Tele

#define CAMERA_MODE_XIAOMI_L12A_D1500_OV64B40 0x7BD // 1981  	  L12A_D1500(OV64B40 OIS_Y)//W
#define CAMERA_MODE_XIAOMI_L12A_D1500_S5K4H7  0x7BE // 1982  	  L12A_D1500(S5K4H7)//UW
#define CAMERA_MODE_XIAOMI_L12A_D1500_GC02M1  0x7BF // 1983  	  L12A_D1500(GC02M1)//Tele

#define CAMERA_MODE_XIAOMI_L2M_D9000_IMX707 0x7E5 // 2021 	  L2M_D9000(IMX707 OIS_Y)//W
#define CAMERA_MODE_XIAOMI_L2M_D9000_OV13B  0x7E6 // 2022 	  L2M_D9000(OV13B)//UW
...
#define MERR_ARC_SN_MERR_BASIC_BASE 10000
#define MERR_ARC_SN_MERR_INVALID_EXPOSURE \
    (MERR_ARC_SN_MERR_BASIC_BASE + 2) // gain * shutter not match EV, result do mf + aidenoise
#define MERR_ARC_SN_MERR_INVALID_EVLIST \
    (MERR_ARC_SN_MERR_BASIC_BASE + 3) // ev list error, result do nothing
#define MERR_ARC_SN_MERR_BAD_SCENE_NOT_DO_HDR \
    (MERR_ARC_SN_MERR_BASIC_BASE + 14) // non HDR case, result do mf + aidenoise

typedef struct _tag_ARC_SN_INPUTINFO
{
    MInt32 i32CameraState; // ARC_SN_CAMERA_STATE_UNKNOW, ARC_SN_CAMERA_STATE_TRIPOD,
                           // ARC_SN_CAMERA_STATE_HAND
    MInt32 i32CurIndex;
    MInt32 i32ImgNum;
...
typedef enum {
    ...
    ARC_SN_SCENEMODE_LANTERN = 8,
    ARC_SN_SCENEMODE_FIREWORKS = 9,
    ARC_SN_SCENEMODE_FLASH_MODE_SCREEN_HALO = 10,
    ARC_SN_SCENEMODE_FLASH_MODE_TORCH = 11,
    ARC_SN_SCENEMODE_FLASH_MODE_SCREEN_HALO_TORCH = 12
} ARC_SN_SCENE_MODE;
 ...
 ************************************************************************/
ARC_SN_API MRESULT ARC_SN_PreProcess(MHandle hHandle // [in] The handle for ArcSoft Super Night
);
...
ARC_SN_API MRESULT ARC_SN_Process(
    ...
    MInt32 i32DeviceOrientation = -1 // The device orientation, 0, 90, 180, 270;
);
