 ...
 ************************************************************************/
ARC_DCVR_API MRESULT ARC_DCVR_SetLogLevel(MInt32 i32LogLevel);
...
ARC_DCVR_API MRESULT ARC_DCVR_GetCaliData( // return MOK if success, otherwise fail
    MHandle hHandle,                       // [in]  The algorithm engine
    MFloat *pCaliDataMtk                   // [out] Calibration data for MTK, size is float[59]
);
#ifdef __cplusplus
}
#endif
