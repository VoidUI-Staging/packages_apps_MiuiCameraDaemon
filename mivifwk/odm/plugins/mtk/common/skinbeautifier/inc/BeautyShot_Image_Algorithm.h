...
public:
     ...
     */
    virtual MRESULT Init(const MInt32 nInterfaceVersion, MInt32 LevelVersion) = 0;
     ...
     * info. [IN] nFaceOrientation: Face Orientation. [0, 90, 180, 270]. [IN]
     * nRegion:BEAUTYSHOT_REGION_DEFAULT(-1), BEAUTYSHOT_REGION_GLOBAL(0),
     * BEAUTYSHOT_REGION_CHINA(1), BEAUTYSHOT_REGION_INDIAN(2),BEAUTYSHOT_REGION_BRAZIL(3),
     */
    virtual MRESULT Process(LPASVLOFFSCREEN pImgIn, LPASVLOFFSCREEN pImgOut, ABS_TFaces *pFacesIn,
                            ABS_TFaces *pFacesOut, MInt32 nFaceOrientation, MInt32 nRegion) = 0;
};
