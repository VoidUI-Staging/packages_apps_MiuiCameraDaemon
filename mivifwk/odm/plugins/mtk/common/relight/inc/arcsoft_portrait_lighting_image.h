...
ARCPLI_API MRESULT ARC_PLI_GetExtraData(MHandle hHandle,  // [in] The algorithm engine
                                        MVoid *pExtraData // [out] The extra data
);

ARCPLI_API MRESULT ARC_PLI_GetExtraDataSize(MHandle hHandle,       // [in] The algorithm engine
                                            MInt32 *pExtraDataSize // [out] The extra data size
);

ARCPLI_API MRESULT ARC_PLI_SetExtraData(MHandle hHandle,         // [in] The algorithm engine
