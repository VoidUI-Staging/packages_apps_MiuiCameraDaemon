...
struct __Dev_Queue
{
    ...
    S64 (*Full)(S64 id);
    S64 (*Clean)(S64 id);
    S64 (*GetWritePtr)(S64 id, void **ptr, S64 length);
    S64 (*MarkWriteDone)(S64 id);
    S64 (*GetReadPtr)(S64 id, void **ptr, S64 length);
