...
enum mappingVersion { ArcSoftBokeh1x = 1, ArcSoftBokeh2x };
...
static DynamicBlurLevel DblCaptureBokeh1x[] = {
    {1.0f, 30}, {1.1f, 26}, {1.2f, 23}, {1.4f, 20}, {1.6f, 18}, {1.8f, 16}, {2.0f, 15},
    {2.2f, 13}, {2.5f, 11}, {2.8f, 10}, {3.2f, 9},  {3.5f, 8},  {4.0f, 8},  {4.5f, 7},
    {5.0f, 6},  {5.6f, 6},  {6.3f, 5},  {7.1f, 4},  {8.0f, 4},  {9.0f, 3},  {10.0f, 2},
    {11.0f, 2}, {13.0f, 1}, {14.0f, 1}, {16.0f, 0},
};

static DynamicBlurLevel DblCaptureBokeh2x[] = {
    {1.0f, 100}, {1.1f, 90}, {1.2f, 80}, {1.4f, 70}, {1.6f, 63}, {1.8f, 56}, {2.0f, 50},
    {2.2f, 46},  {2.5f, 43}, {2.8f, 40}, {3.2f, 36}, {3.5f, 33}, {4.0f, 30}, {4.5f, 26},
    {5.0f, 23},  {5.6f, 20}, {6.3f, 16}, {7.1f, 13}, {8.0f, 10}, {9.0f, 8},  {10.0f, 6},
    {11.0f, 5},  {13.0f, 3}, {14.0f, 1}, {16.0f, 0},
};
#else
static DynamicBlurLevel DblCaptureBokeh1x[] = {
    {1.0f, 50}, {1.1f, 46}, {1.2f, 42}, {1.4f, 38}, {1.6f, 34}, {1.8f, 30}, {2.0f, 26},
    {2.2f, 23}, {2.5f, 20}, {2.8f, 18}, {3.2f, 16}, {3.5f, 15}, {4.0f, 13}, {4.5f, 11},
    {5.0f, 10}, {5.6f, 9},  {6.3f, 8},  {7.1f, 7},  {8.0f, 6},  {9.0f, 5},  {10.0f, 4},
    {11.0f, 3}, {13.0f, 2}, {14.0f, 1}, {16.0f, 0},
};
