...
// transplant from here
// https://gerrit.pt.mioffice.cn/c/platform/vendor/xiaomi/proprietary/mivifwk/+/2392496
// design documents: https://xiaomi.f.mioffice.cn/docs/dock4RGiRbEmKbn06Q4ivifJqlg#
    ...
    : mPsiMonitorStart{false}, mThreadExit{false}, mIsHighMem{false}, mSnapShotCounter{0}
{
    ...
    if (GetTotalRAM() <= (unsigned long)8 * 1024 * 1024 * 1024) {
